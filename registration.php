...
?>
    <div class = "form-container">
        <form action="" method = "post">
            <h3>REGISTER ON BOOKIFY</h3>
        <input type ="text" name="name" placeholder="YOUR NAME" required class="box">
        <input type="email" name="email" placeholder = "YOUR E-MAIL" required class="box">
        ...
        <p>Registered Already?<a href="login.php"> Login to Your Bookify Account</a></p>    
        </form>
</div>
</body>
</html>